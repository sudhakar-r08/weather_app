...
//    }
    ...
    fun getColor(): Int {
        return when (dt?.let { getDateTime(it) }) {
            DayOfWeek.MONDAY -> Color.parseColor("#00BCD4")
            DayOfWeek.TUESDAY -> Color.parseColor("#00BCD4")
            DayOfWeek.WEDNESDAY -> Color.parseColor("#00BCD4")
            DayOfWeek.THURSDAY -> Color.parseColor("#00BCD4")
            DayOfWeek.FRIDAY -> Color.parseColor("#00BCD4")
            DayOfWeek.SATURDAY -> Color.parseColor("#00BCD4")
            DayOfWeek.SUNDAY -> Color.parseColor("#00BCD4")
